...
import com.juntian.rxjavaretrofitmvvm.databinding.FmtPayBinding;
import com.juntian.rxjavaretrofitmvvm.model.bean.WechatPayInfo;
import com.juntian.rxjavaretrofitmvvm.view.PayView;
import com.juntian.rxjavaretrofitmvvm.viewmodel.PayVM;
...
public class PayFragment extends BaseFragment<PayVM, FmtPayBinding> implements PayView {
    ...
    protected PayVM createVM() {
        return new PayVM(mContext, this);
    }
...
//        mPwdDialog = AlertDialogUtil.showPwdDialog(mContext, mSumMoney, new GridPasswordView.OnPasswordChangedListener() {
//            @Override
