/*
    ...
    Copyright (c) 2014 ShengDao Tech DevicesInfo Limited
 */

package com.juntian.basicapp.common;
...
public class ActivityPageManager {
    ...
    public void finishPreviousActivity() {
        ...
        for (int i = 0; i < activityStack.size(); i++) {
            ...
            if (null != activity) {
                LogUtils.e("ActivityPageManager", "finishPreviousActivity: " + activity.getClass().getSimpleName());
                activity.finish();
            }
        }
    }
