package com.junzhitian.basicapp.qmui.qmuiwidget.ratbar;
...
public class NormalRatingBar extends LinearLayout {
     ...
     * @param attrs
     */
    public NormalRatingBar(Context context, AttributeSet attrs) {
        super(context, attrs);
        setOrientation(LinearLayout.HORIZONTAL);
        TypedArray mTypedArray = context.obtainStyledAttributes(attrs, R.styleable.NormalRatingBar);
        starImageSize = mTypedArray.getDimension(R.styleable.NormalRatingBar_starImageSize, 20);
        starPadding = mTypedArray.getDimension(R.styleable.NormalRatingBar_starPadding, 10);
        starStep = mTypedArray.getFloat(R.styleable.NormalRatingBar_starStep, 1.0f);
        stepSize = StepSize.fromStep(mTypedArray.getInt(R.styleable.NormalRatingBar_stepSize, 1));
        starCount = mTypedArray.getInteger(R.styleable.NormalRatingBar_starCount, 5);
        starEmptyDrawable = mTypedArray.getDrawable(R.styleable.NormalRatingBar_starEmpty);
        starFillDrawable = mTypedArray.getDrawable(R.styleable.NormalRatingBar_starFill);
        starHalfDrawable = mTypedArray.getDrawable(R.styleable.NormalRatingBar_starHalf);
        mClickable = mTypedArray.getBoolean(R.styleable.NormalRatingBar_clickable, true);
        mTypedArray.recycle();
