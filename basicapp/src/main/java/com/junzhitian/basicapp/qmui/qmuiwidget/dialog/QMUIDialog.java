package com.junzhitian.basicapp.qmui.qmuiwidget.dialog;
...
import com.junzhitian.basicapp.qmui.QMUIDisplayHelper;
import com.junzhitian.basicapp.qmui.QMUIResHelper;
import com.junzhitian.basicapp.qmui.QMUIViewHelper;
import com.junzhitian.basicapp.qmui.qmuiwidget.QMUIWrapContentScrollView;
...
public class QMUIDialog extends Dialog {
    ...
    public QMUIDialog(Context context) {
        this(context, R.style.CommonUITheme_Dialog);
    }
    ...
    public static class MessageDialogBuilder extends QMUIDialogBuilder<MessageDialogBuilder> {
        ...
        public MessageDialogBuilder(Context context) {
            ...
            mTextView.setTextColor(QMUIResHelper.getColor(mContext, R.color.text_color_666));
        ...
        protected void onCreateContent(QMUIDialog dialog, ViewGroup parent) {
            if (mMessage != null && mMessage.length() != 0) {
                ...
                mTextView.setPadding(
                        QMUIResHelper.getDimen(mContext, R.dimen.qmui_dialog_padding_horizontal),
                        QMUIResHelper.getDimen(mContext, hasTitle() ? R.dimen.qmui_dialog_content_padding_top : R.dimen.qmui_dialog_content_padding_top_when_no_title),
                        QMUIResHelper.getDimen(mContext, R.dimen.qmui_dialog_padding_horizontal),
                        QMUIResHelper.getDimen(mContext, R.dimen.qmui_dialog_content_padding_bottom)
                );
...
//                mTextView.setText(mMessage);
//                mTextView.setPadding(
//                        QMUIResHelper.getAttrDimen(mContext, R.dimen.qmui_dialog_padding_horizontal),
//                        QMUIResHelper.getAttrDimen(mContext, hasTitle() ? R.dimen.qmui_dialog_confirm_content_padding_top : R.attr.qmui_dialog_content_padding_top_when_no_title),
//                        QMUIResHelper.getAttrDimen(mContext, R.dimen.qmui_dialog_padding_horizontal),
//                        QMUIResHelper.getAttrDimen(mContext, R.dimen.qmui_dialog_confirm_content_padding_bottom)
//                );
...
//    }
    ...
    public static class EditTextDialogBuilder extends QMUIDialogBuilder<EditTextDialogBuilder> {
        ...
        public EditTextDialogBuilder(Context context) {
            ...
            mEditText.setHintTextColor(QMUIResHelper.getColor(mContext, R.color.hint_text_color));
            mEditText.setTextColor(QMUIResHelper.getColor(mContext, R.color.text_color_666));
        ...
        protected void onCreateContent(QMUIDialog dialog, ViewGroup parent) {
            ...
            lp.topMargin = QMUIResHelper.getAttrDimen(mContext, hasTitle() ? R.dimen.qmui_dialog_edit_content_padding_top : R.dimen.qmui_dialog_content_padding_top_when_no_title);
            lp.leftMargin = QMUIResHelper.getAttrDimen(mContext, R.dimen.qmui_dialog_padding_horizontal);
            lp.rightMargin = QMUIResHelper.getAttrDimen(mContext, R.dimen.qmui_dialog_padding_horizontal);
            lp.bottomMargin = QMUIResHelper.getAttrDimen(mContext, R.dimen.qmui_dialog_edit_content_padding_bottom);
    ...
    private static class MenuBaseDialogBuilder<T extends QMUIDialogBuilder> extends QMUIDialogBuilder<T> {
        ...
        public MenuBaseDialogBuilder(Context context) {
            ...
            mMenuItemLp = new LinearLayout.LayoutParams(
                    ...
                    QMUIResHelper.getDimen(mContext, R.dimen.qmui_dialog_content_list_item_height)
            );
        ...
        protected void onCreateContent(QMUIDialog dialog, ViewGroup parent) {
            ...
            mMenuItemContainer.setPadding(
                    0, QMUIResHelper.getDimen(mContext, R.dimen.qmui_dialog_content_padding_top_when_list),
                    0, QMUIResHelper.getDimen(mContext, mActions.size() > 0 ? R.dimen.qmui_dialog_content_padding_bottom : R.dimen.qmui_dialog_content_padding_bottom_when_no_action)
            );
            ...
            if (mMenuItemViews.size() == 1) {
                ...
                if (hasTitle()) {
                    QMUIViewHelper.setPaddingTop(mMenuItemContainer, QMUIResHelper.getDimen(mContext, R.dimen.qmui_dialog_content_padding_top_when_list));
                }
                if (mActions.size() > 0) {
                    QMUIViewHelper.setPaddingBottom(mMenuItemContainer, QMUIResHelper.getDimen(mContext, R.dimen.qmui_dialog_content_padding_bottom));
                }
            }
