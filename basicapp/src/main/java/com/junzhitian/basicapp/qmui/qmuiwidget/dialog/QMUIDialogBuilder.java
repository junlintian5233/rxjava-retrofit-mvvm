...
public abstract class QMUIDialogBuilder<T extends QMUIDialogBuilder> {
    ...
    public QMUIDialog create() {
        return create(R.style.CommonUITheme_Dialog);
    }
    ...
    protected void onCreateTitle(QMUIDialog dialog, ViewGroup parent) {
        if (hasTitle()) {
            ...
            mTitleView.setTextColor(QMUIResHelper.getColor(mContext, R.color.text_color_666));
            ...
            mTitleView.setPadding(
                    ...
                    QMUIResHelper.getDimen(mContext, R.dimen.qmui_dialog_title_margin_top),
                    QMUIResHelper.getDimen(mContext, R.dimen.qmui_dialog_padding_horizontal),
                    0
            );
    ...
    protected void onCreateHandlerBar(final QMUIDialog dialog, ViewGroup parent) {
        ...
        if (size > 0 || mLeftAction != null) {
            ...
            mActionContainer.setPadding(
                    QMUIResHelper.getDimen(mContext, R.dimen.qmui_dialog_action_container_margin_horizontal),
                    0,
                    QMUIResHelper.getDimen(mContext, R.dimen.qmui_dialog_action_container_margin_horizontal),
