    ...
    public View generateActionView(Context context, final QMUIDialog dialog, final int index, boolean hasLeftMargin) {
        ...
        if (mActionType == ACTION_TYPE_BLOCK) {
            ...
            if (mActionProp == ACTION_PROP_NEGATIVE) {
                mButton.setTextColor(QMUIResHelper.getColor(mContext, R.color.main_button_color));
            } else {
                mButton.setTextColor(QMUIResHelper.getColor(mContext, R.color.text_color_666));
                //modify by TJ
                mButton.setBackgroundColor(Color.TRANSPARENT);
//                mButton.setBackgroundColor(ContextCompat.getColor(context, R.color.white));
            }
    ...
    public static Button generateSpanActionButton(Context context, String text, int iconRes, boolean hasLeftMargin) {
        ...
        LinearLayout.LayoutParams lp = new LinearLayout.LayoutParams(
                ...
                QMUIResHelper.getDimen(context, R.dimen.qmui_dialog_action_button_height));
        if (hasLeftMargin) {
            lp.leftMargin = QMUIResHelper.getDimen(context, R.dimen.qmui_dialog_action_button_margin_left);
        }
        button.setLayoutParams(lp);
        button.setMinHeight(QMUIResHelper.getDimen(context, R.dimen.qmui_dialog_action_button_height));
        button.setMinWidth(QMUIResHelper.getDimen(context, R.dimen.qmui_dialog_action_button_min_width));
        button.setMinimumWidth(QMUIResHelper.getDimen(context, R.dimen.qmui_dialog_action_button_min_width));
        button.setMinimumHeight(QMUIResHelper.getDimen(context, R.dimen.qmui_dialog_action_button_height));
        button.setText(text);
        if (iconRes != 0) {
            ...
            if (drawable != null) {
                ...
                button.setCompoundDrawablePadding(QMUIResHelper.getDimen(context, R.dimen.qmui_dialog_action_drawable_padding));
            }
        ...
        button.setTextColor(QMUIResHelper.getColor(context, R.color.text_color_666));
//		button.setBackground(QMUIResHelper.getAttrDrawable(context, R.attr.qmui_dialog_action_btn_bg));
        final int paddingHor = QMUIResHelper.getDimen(context, R.dimen.qmui_dialog_action_container_margin_horizontal);
    ...
    public static class BlockActionView extends FrameLayout {
        ...
        private void init(String text, int iconRes) {
            LinearLayout.LayoutParams parentLp = new LinearLayout.LayoutParams(
                    ...
                    QMUIResHelper.getDimen(getContext(), R.dimen.qmui_dialog_action_button_height));
            ...
            setPadding(
                    QMUIResHelper.getDimen(getContext(), R.dimen.qmui_dialog_padding_horizontal),
                    0,
                    QMUIResHelper.getDimen(getContext(), R.dimen.qmui_dialog_padding_horizontal),
                    0
            );
            ...
            if (iconRes != 0) {
                ...
                if (drawable != null) {
                    ...
                    mButton.setCompoundDrawablePadding(QMUIResHelper.getDimen(getContext(), R.dimen.qmui_dialog_action_drawable_padding));
                }
            ...
            mButton.setTextColor(QMUIResHelper.getColor(getContext(), R.color.text_color_666));
