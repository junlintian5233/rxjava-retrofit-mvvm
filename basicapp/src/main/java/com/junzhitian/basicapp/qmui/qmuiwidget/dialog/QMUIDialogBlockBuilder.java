...
public class QMUIDialogBlockBuilder extends QMUIDialogBuilder<QMUIDialogBlockBuilder> {
    ...
    protected void onCreateContent(QMUIDialog dialog, ViewGroup parent) {
        ...
        contentTv.setTextColor(QMUIResHelper.getColor(mContext, R.color.text_color_666));
        ...
        contentTv.setPadding(
                ...
                QMUIResHelper.getDimen(mContext, R.dimen.qmui_dialog_padding_horizontal),
                QMUIResHelper.getDimen(mContext, R.dimen.qmui_dialog_content_padding_bottom_when_action_block)
        );
    ...
    protected void onCreateHandlerBar(QMUIDialog dialog, ViewGroup parent) {
        ...
        if (size > 0) {
            ...
            layout.setPadding(
                    ...
                    0,
                    0,
                    QMUIResHelper.getDimen(mContext, R.dimen.qmui_dialog_action_container_margin_bottom));
