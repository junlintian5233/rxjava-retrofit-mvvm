...
//        QMUIViewHelper.setBackgroundKeepingPadding(this, QMUIResHelper.getAttrDrawable(context, R.attr.qmui_dialog_content_list_item_bg));
        setPadding(
                QMUIResHelper.getDimen(context, R.dimen.qmui_dialog_padding_horizontal), 0,
                QMUIResHelper.getAttrDimen(context, R.dimen.qmui_dialog_padding_horizontal), 0
        );
    }

    public static TextView createItemTextView(Context context) {
        TextView tv = new TextView(context);
        tv.setTextColor(QMUIResHelper.getColor(context, R.color.text_color_666));
    ...
    public static class MarkItemView extends QMUIDialogMenuItemView {
        ...
        public MarkItemView(Context context) {
            ...
            checkLp.leftMargin = QMUIResHelper.getDimen(mContext, R.dimen.qmui_dialog_menu_item_check_icon_margin_horizontal);
