package com.junzhitian.basicapp.qmui;
...
public class QMUIResHelper {
    ...
    public static int getDimen(Context context, int attrRes){
        return (int)context.getResources().getDimension(attrRes);
    }
    public static int getColor(Context context, int attrRes){
        return (int)context.getResources().getColor(attrRes);
    }
}
