...
import com.junzhitian.basicapp.qmui.qmuiwidget.QMUILoadingView;
...
public class QMUITipDialog extends Dialog {
    ...
    public QMUITipDialog(Context context) {
        this(context, R.style.CommonUITheme_TipDialog);
    }
     ...
     * @param autoClose
     */
    public void showDealy(long dealy,long autoClose){
