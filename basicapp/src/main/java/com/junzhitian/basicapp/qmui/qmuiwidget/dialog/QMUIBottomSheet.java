...
import com.junzhitian.basicapp.qmui.QMUILangHelper;
...
public class QMUIBottomSheet extends Dialog {
    ...
    public QMUIBottomSheet(Context context) {
        super(context, R.style.CommonUITheme_BottomSheet);
    }
    ...
    public static class BottomListSheetBuilder {
        ...
        private boolean needToScroll() {
            ...
            int itemHeight = QMUIResHelper.getDimen(mContext, R.dimen.qmui_bottom_sheet_list_item_height);
            ...
            if (mTitleTv != null && !QMUILangHelper.isNullOrEmpty(mTitle)) {
                totalHeight += QMUIResHelper.getDimen(mContext, R.dimen.qmui_bottom_sheet_title_height);
            }
    ...
    public static class BottomGridSheetBuilder implements View.OnClickListener {
        ...
        private View buildViews() {
            ...
            if (mBottomButton != null) {
                if (mIsShowButton) {
                    ...
                    int dimen = QMUIResHelper.getDimen(mContext, R.dimen.qmui_bottom_sheet_grid_padding_vertical);
        ...
        private int calculateItemWidth(int width, int maxItemCountInEachLine, int paddingLeft, int paddingRight) {
            if (mMiniItemWidth == -1) {
                mMiniItemWidth = QMUIResHelper.getDimen(mContext, R.dimen.qmui_bottom_sheet_grid_item_mini_width);
            }
