...
public class GridBanner extends FrameLayout implements ViewPager.OnPageChangeListener {
    ...
    public GridBanner isAutoPlay(boolean isAutoPlay) {
        this.isAutoPlay = isAutoPlay;
        return this;
    }

    public GridBanner setImageLoader(ViewLoaderInterface imageLoader) {
        this.imageLoader = imageLoader;
        return this;
    }

    public GridBanner setDelayTime(int delayTime) {
        this.delayTime = delayTime;
        return this;
    }

    public GridBanner setIndicatorGravity(int type) {
        switch (type) {
    ...
    public GridBanner setBannerAnimation(Class<? extends ViewPager.PageTransformer> transformer) {
        try {
     ...
     * @return Banner
     */
    public GridBanner setOffscreenPageLimit(int limit) {
        if (viewPager != null) {
     ...
     * @return Banner
     */
    public GridBanner setPageTransformer(boolean reverseDrawingOrder, ViewPager.PageTransformer transformer) {
        viewPager.setPageTransformer(reverseDrawingOrder, transformer);
        return this;
    }

    public GridBanner setBannerTitles(List<String> titles) {
        this.titles = titles;
        return this;
    }

    public GridBanner setBannerStyle(int bannerStyle) {
        this.bannerStyle = bannerStyle;
        return this;
    }

    public GridBanner setViewPagerIsScroll(boolean isScroll) {
        this.isScroll = isScroll;
        return this;
    }

    public GridBanner setImages(List<?> imageUrls) {
...
//                Log.i(tag, "curr:" + currentItem + " count:" + count);
    ...
    public boolean dispatchTouchEvent(MotionEvent ev) {
        Log.e(tag, ev.getAction() + "--" + isAutoPlay);
        if (isAutoPlay) {
...
//        Log.i(tag,"currentItem: "+currentItem);
    ...
    @Deprecated
    public GridBanner setOnBannerClickListener(OnBannerClickListener listener) {
     ...
     * @return
     */
    public GridBanner setOnBannerListener(OnBannerListener listener) {
        this.listener = listener;
        return this;
    }

    public GridBanner setStartIndex(int index) {
